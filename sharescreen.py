#!/usr/bin/env python3
'''
Based on https://github.com/di/screenshare
One file screen share server. 
Dependencies: All you need is python3. Flask and pyscreenshot will be installed automatically.
'''
